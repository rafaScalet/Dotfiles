...
set -g @is-dark "#{?#{==:#{E:@theme},'prefer-dark'},black,brightwhite}"
set -g @is-light "#{?#{==:#{E:@theme},'prefer-dark'},white,black}"
...
set -g @calendar "#[fg=blue,bg=default]#[bg=blue,fg=#{E:@is-dark}] "
